...
public class ApplicationUtils {
    ...
    public static String URL = "http://172.16.1.53:8080/";
    ...
    public boolean installPackage(String apkFile) {
        Runtime tr = Runtime.getRuntime();
        Process p;
        try {
            p = tr.exec("pm install " + apkFile);
            BufferedReader reader = new BufferedReader(new InputStreamReader(p.getInputStream()));
            String lineRead = null;
            Log.d("Home", "STD output of excuting 'pm install " + apkFile);
            while ((lineRead = reader.readLine()) != null) {
                Log.d("Home", lineRead);
            }

            BufferedReader stdError = new BufferedReader(new InputStreamReader(p.getErrorStream()));
            Log.d("Diplomat", "ERR output of excuting 'pm install " + apkFile);
    ...
    public boolean removePackage(String packageName) {
        ...
        Process p;
        try {
            p = tr.exec("pm uninstall " + packageName);
    ...
    public String downloadTAppEgg(String packageName, String name, Context context) {
        HttpGet get = new HttpGet();
        try {
            get.setURI(new URI(URL + packageName + "/egg"));
