...
public class LoaderImageView extends LinearLayout {
    ...
    public void setLocalDrawable(final Drawable drawable) {
    ...
    private Handler _hookHandler = null;

    public void setImageDrawable(final String imageUrl, Handler handler) {
        _hookHandler = handler;
        setImageDrawable(imageUrl);
    }
    ...
    ImageHandler imageLoadedHandler = new ImageHandler();
